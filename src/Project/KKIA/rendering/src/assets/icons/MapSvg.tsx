...
const MapSvg: React.FC<MapSvgProps> = ({ className }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.7219 6.10192C14.8922 6.18628 15 6.35991 15 6.54999V19.7031C15 20.0716 14.615 20.3135 14.283 20.1536L10.033 18.106C9.85998 18.0226 9.75 17.8476 9.75 17.6555V4.44522C9.75 4.07437 10.1396 3.83257 10.4719 3.99716L14.7219 6.10192Z"
        fill="currentColor"
      />
      <path
